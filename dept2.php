...
if(strcmp($submit,"Next")==0)
{
  ...
  $sql="insert into dept2 values('$course','$curriculum','$syllabus')";
            ...
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                    ...
                    <script type="text/javascript">
                        function validation() {
                            var course = document.d2.course.value;
                            var curriculum = document.d2.curriculum.value;
                            var syllabus = document.d2.syllabus.value;

                            if (course == "") {
                                alert("Enter the Course Name");
                                document.d2.course.focus();
                                return false;
                            }
                            else if (curriculum == "") {
                                alert("Enter the Curriculum details");
                                document.d2.curriculum.focus();
                                return false;
                            }
                            else if (syllabus == "") {
                                alert("Enter the Syllabus details");
                                document.d2.syllabus.focus();
                                return false;
                            }
                        }
                    </script>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form method="post" name="d2" action="">
                                                        <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">1. Course Name:</label>
                                                                <div class="col-sm-9">
                                                            ...
                                                            <div class="form-group row">
                                                                <label
                                                                    class="col-sm-3 col-form-label">2. Curriculum</label>
                                                                <div class="col-sm-9">
                                                                    <textarea name="curriculum" rows="3" columns="30" class="form-control"
                                                                    ></textarea>
                                                                </div>
                                                            </div>
                                                            
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">3. Date of last Syllabus Revised:</label>
                                                                <div class="col-sm-9">
                                                                    <input type="date" name="syllabus" class="form-control">
                                                                </div>
                                                            </div>
                                                            <br>
                                                        <center>
