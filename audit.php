                    ...
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              <li class="active">
                                  <a href="audit.php" class="waves-effect waves-dark">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-footer bg-c-red">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Administrative Audit</p>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-footer bg-c-red">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Academic Audit</p>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-footer bg-c-red">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Library Audit</p>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-footer bg-c-red">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Financial Audit</p>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-footer bg-c-red">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Green Audit</p>
                                                            </div>
