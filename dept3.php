...
if(strcmp($submit,"Next")==0)
{
  ...
  $sql="insert into dept3 values('$name','$category','$mou','$validity','$details')";
        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu active pcoded-trigger">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Department
                                            Profile</span>
                    ...
                    function validation() {
                        var vname = document.d3.name.value;
                        var vdept = document.d3.category.value;
                        var vcol = document.d3.mou.value;
                        var vphone = document.d3.validity.value;
                        var details = document.d3.details.value;

                        if (vname == "") {
                            alert("Enter the Name");
                            document.d3.name.focus();
                            return false;
                        } else if (vdept == "") {
                            alert("Enter the category details");
                            document.d3.category.focus();
                            return false;
                        } else if (vcol == "") {
                            alert("Enter the MoU details");
                            document.d3.mou.focus();
                            return false;
                        } else if (vphone == "") {
                            alert("Enter the validity details");
                            document.d3.validity.focus();
                            return false;
                        } else if (details == "") {
                            alert("Enter the details");
                            document.d3.details.focus();
                            return false;
                        }
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form method="post" name="d3" action="">
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">1. Institution
                                                                    Name:</label>
                                                                <div class="col-sm-9">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">2.
                                                                    Category:</label>
                                                                <div class="col-sm-9">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">3. MoU
                                                                    Date:</label>
                                                                <div class="col-sm-9">
                                                                    <input type="date" name="mou" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">4.
                                                                    Validity:</label>
                                                                <div class="col-sm-9">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">5.
                                                            Details:</label>
                                                        <div class="col-sm-9">
