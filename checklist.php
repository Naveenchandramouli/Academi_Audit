                            ...
                            <table>
                                <tr>
                                    ...
                                    <label class="col-sm-7 col-form-label"> 
                                        ...
                                        <select name="cat" id="dynam" class="col-sm-2 col-form-label" >
                                        ...
                                        if(strcmp($ans,"Aided")==0)
                                        {
                                            ?>
                                            <select name="dept" class="col-sm-2 col-form-label" >
                                ...
                                <tr>
                                <td>
                                    <label class="col-sm-12 col-form-label">5. Inter Departmental Collaborative
                                    programmes </label>
                                ...
                                <tr>
                                    <td>
                                        <label class="col-sm-12 col-form-label">
                                            ...
                                            Alumni Series, Association talks, Special workshops or Seminars)
                                        </label>
                                ...
                                <tr>
                                    <td>
                                        <label class="col-sm-12 col-form-label">8. Student Feedback (by faculty/subject wise)
                                            </label>
                                ...
                                <tr>
                                    <td>
                                        <label class="col-sm-12 col-form-label">11. Strengths, weaknesses,
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <center>
                                        ...
                                        <b>1</b>
                                        &nbsp;
                                        <input type="submit" name="cl1"
                                            value=">"  onclick="return validate()">
                                    </center>
                                </div>
                            </div>
                        </form>
