...
if(strcmp($submit,"Register")==0)
{
  ...
  $sql="insert into demo values('$name','$mobile','$email','$college','$events')";
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu active pcoded-trigger">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Registeration</span>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                <label
                                                                    class="col-sm-2 col-form-label">Events:</label>
                                                                <div class="col-sm-10">
                                                                <select name="events" class="form-control">
                                                                        <option value="">Select One Value Only
                                                                        </option>
                                                                        <option value="techwoods">Techwoods</option>
                                                                        <option value="aurush">Aurush</option>
                                                                    </select>
                                                                </div>
                                                            </div>
