...
if(strcmp($submit,"Update")==0)
{
  ...
  $sql="update members set cate='$cate',name='$name',desig='$desig',dept='$dept',college='$college' where phone='$phone' ";
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        if (isset($_GET['phone'])) {
                                                            ...
                                                            $sql = "select * from members where phone='$url'";
                                                            $res = mysqli_query($conn, $sql);
                                                        ...
                                                        ?>
                                                                <form method="post" name="f1" action="">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control" name="dept" value="<?= $result['dept']; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-2 col-form-label">Email</label>
                                                                        <div class="col-sm-10">
                                                                            <input type="text" name="college" class="form-control" value="<?= $result['college']; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-2 col-form-label">Phone Number</label>
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control" name="phone" max="10" value="<?= $result['phone']; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <br>
                                                                    <center>
                                                                        <input type="submit" name="submit" value="Update" onclick="return validation()">&nbsp;&nbsp;
                                                        ...
                                                        <?php
                                                                ...
                                                                echo "Not found!, Please retry after sometimes.";
                                                            }
                                                        }
                                                        ?>
