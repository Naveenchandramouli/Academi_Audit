...
if(strcmp($submit,"Back")==0)
{
  header("location:admin.php");
}

if(strcmp($submit,"Schedule")==0)
{
...
<!--
    $dos=$_POST['dos'];
    $sql="insert into schedule values('$name','$ph','$cate','$dept','$college','$dos') ";
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="date" class="form-control" name="dos" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Timing</label>
                                                                <div class="col-sm-10">
                                                                    <input type="time" class="form-control" name="phone" required>
                                                                </div>
                                                            </div>
